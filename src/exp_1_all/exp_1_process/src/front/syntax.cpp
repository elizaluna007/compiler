...
{
    std::cout << "parseTerm: " << toString(expected) << std::endl;
    std::cout << "type " << toString(token_stream[index].type) << std::endl;
    std::cout << "value " << token_stream[index].value << std::endl;
...
bool frontend::Parser::parseUnaryExp(frontend::UnaryExp *root)
{
    ...
    else if (CUR_TOKEN_IS(IDENFR))
    {
        ...
        //     {
        //         PARSE(funcrparams, FuncRParams);
        //         bool b2 = parseFuncRParams(funcrparams);
        //         b1 = b1 && b2;
        //     }
        //     PARSE_TOKEN(RPARENT);
        // }
        ...
        // {
        //     PARSE(primaryexp, PrimaryExp);
        //     bool b2 = parsePrimaryExp(primaryexp);
        //     b1 = b1 && b2;
        // }
    }
    else
...
void frontend::Parser::_log_(AstNode *node, bool b)
{
    if (b == true)
    {
        std::cout << "in parse" << toString(node->type) << ", bool = "
                  << "yes" << '\n';
    }
    else
    {
