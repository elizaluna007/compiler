...
std::string ir::CallInst::draw() const {
    std::string res = "call " + this->des.name + " (" + toString(this->des.type) + ")" + ", " + this->op1.name + "(";
...
std::string ir::Instruction::draw() const {
    ...
    switch (this->op) {
        ...
        default:
            return toString(this->op) + " " + this->des.name + " (" + toString(this->des.type) + ") " + ", " + this->op1.name + " (" + toString(this->op1.type) + ")" + ", " + this->op2.name +" (" + toString(this->op2.type) + ")";
